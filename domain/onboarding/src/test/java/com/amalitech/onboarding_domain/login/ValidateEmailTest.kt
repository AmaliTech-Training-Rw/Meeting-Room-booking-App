...
class ValidateEmailTest {
    @MockK
    private lateinit var validateEmail: com.amalitech.onboarding_domain.login.use_case.ValidateEmail

    @Before
    fun setup() {
        validateEmail = spyk(com.amalitech.onboarding_domain.login.use_case.ValidateEmail())
    }
