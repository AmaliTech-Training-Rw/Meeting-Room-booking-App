...
sealed class NavigationItem(var title:String, var route:String, var icon: ImageVector){
    ...
    object BookingRequests : NavigationItem("Booking Requests", "my_bookings_route" ,Icons.Default.Bookmarks)
    ...
    object BookingHistory : NavigationItem("Booking History", "booking_history_route" ,Icons.Default.History)
